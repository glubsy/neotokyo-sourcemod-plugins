...
#include "funvotes/voteneorestartthis.sp"
...
public OnPluginStart()
{
	...
	LoadTranslations("funvotes-NT.phrases");
	...
	RegAdminCmd("sm_voterestart", Command_VoteNeoRestart, ADMFLAG_VOTE, "sm_voterestart");
	...
	g_Cvar_Limits[5] = CreateConVar("sm_vote_restart", "0.60", "percent required for successful friendly fire vote.", 0, true, 0.05, true, 1.0);
	...
	else if (action == MenuAction_VoteEnd)
	{
		...
		else
		{
			...
			switch (g_voteType)
			{
				...
				{
					PrintToChatAll("[SM] %t", "Cvar changed", "neo_restart_this", (g_Cvar_Neorestart.BoolValue ? "0" : "1"));
